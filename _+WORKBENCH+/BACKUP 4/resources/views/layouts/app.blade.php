...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <meta name="description" content="BarterBread is Ghana's first online barter trading platform. Swap any product or service!">
        ...
        <title>BarterBread&reg; - The first online barter trading platform in Ghana.</title>
            ...
            <footer>
                <ul class="col-ul">
                    <li>
                        ...
                        <a href="{{ url('/services') }}">Services</a><br>
                    ...
                    <li>
                        ...
                        @endif
                        <a href="{{ url('/list-offer') }}" class="orange-blackBtn">List Offer</a>
                    </li>
                    <li>
                        <h2>Customer Service</h2>
                        <a href="{{ url('/support-center') }}">Support Center</a><br>
                        <a href="{{ url('/howtos') }}">How To's</a><br>
                    ...
                    <li class="site-name">
                        ...
                        <article>
                            <i class="fa fa-phone fa-fw"></i> +233 12 345 6789<br>
