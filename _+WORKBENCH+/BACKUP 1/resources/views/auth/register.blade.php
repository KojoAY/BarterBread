                ...
                <section class="page-content-holder">
                    ...
                    <ul class="reg-ul">
                        ...
                        <li class="right-col">
                            ...
                            <form method="post" action="{{ url('/traders/register') }}" enctype="multipart/form-data" class="trader-regfrm">
                                {{ csrf_field() }}
                                ...
                                <input id="userID" type="hidden" class="form-control" name="userID" value="<?php echo 'BBT' . rand(111,999) . '-' . strtoupper(str_random(6)); ?>">
                            ...
                            <section class="to-login">
                                ...
                                <a href="{{ url('/traders/login') }}" id="login-btn">Login</a>
                            </section>
