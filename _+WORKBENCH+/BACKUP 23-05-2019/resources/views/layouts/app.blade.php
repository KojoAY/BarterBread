...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <meta name="description" content="{{ config('app.name', 'BarterBread') }} is Ghana's first online barter trading platform. Swap any product or service!">
        ...
        <title>{{ config('app.name', 'BarterBread') }} {{ @$pageTitle }}</title>
