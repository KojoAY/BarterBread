@extends('layouts.app')
    @section('content')
            ...
            <section class="main-content-block">
                <article class="bread-crumbs"><a href="{{ url('/') }}">home</a> &map; my offers &map; offers received &map; {{ strtolower($getOfferDetails->title) }}</article>
                ...
                <section class="page-content-holder">
                    ...
                    <section class="accman-content">
                        ...
                        <ul class="man-offer-made-rece-list">
                            <?php $cntOM = 0; ?>
                            @foreach($getOffersReceived as $offerMade)
                            <li>
                                <?php
                            ...
                            {!! ($cntOM == 0) ? "<li><article style=\"text-align: center; margin-top: 10%;\">No offers received yet.</article></li>" : "" !!}

                        </ul>

                        {!! $getOffersReceived->render() !!}
                    </section>
                </section>
            </section>
    @endsection