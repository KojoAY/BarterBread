...
Route::get('/trader/offers/listed-offers', 'ManageOffersController@showOffersListed');
Route::get('/trader/offers/listed-offers/details/{oid}/{otitle}', 'ManageOffersController@showOffersListedDetails');
Route::get('/trader/offers/edit/{oid}/{otitle}', 'ManageOffersController@showEditOffersListedDetails');
Route::post('/trader/offers/edit/{oid}/{otitle}', 'ManageOffersController@updateOffersListedDetails');
Route::get('/trader/offers/del/{oid}/{otitle}', 'ManageOffersController@deleteOffersListedDetails');
//Route::get('/trader/offers/stop/{oid}/{otitle}', 'ManageOffersController@endOffer');

Route::get('/trader/offers/offers-made', 'ManageOffersController@showOffersMadeList'); 
Route::get('/trader/offers/offers-made/details/{oid}/{otitle}', 'ManageOffersController@showOffersMadeDetails');
