...
class ManageOffersController extends Controller
{
    ...
    public function index() {
    	...
    	if(Session::has("traderToken")) {
	    	...
	    	return view('account_manager.my_offers.offer_dashboard')->with($data);
	    } else {
    ...
    public function showOffersListed() {
    	// show offer list
	    $lastURL = $_SERVER['REQUEST_URI'];
	    $linkLength = (strlen($lastURL) - 1);
	    $fullURL = substr($lastURL, -$linkLength);
...
/*
    ...
    public function showOffersListedDetails($oid, $otitle) {
    	...
    	if (Session::has("traderToken")) {
	    	...
	    	return view('account_manager.my_offers.show_offer_listed_details')->with($data);
    ...
    public function showEditOffersListedDetails($oid, $otitle) {
    	// 
    	$lastURL = $_SERVER['REQUEST_URI'];
	    $linkLength = (strlen($lastURL) - 1);
	    $fullURL = substr($lastURL, -$linkLength);
    ...
    public function updateOffersListedDetails(Request $request, $oid, $otitle) {
	    // 
    	$lastURL = $_SERVER['REQUEST_URI'];
	    $linkLength = (strlen($lastURL) - 1);
	    $fullURL = substr($lastURL, -$linkLength);
    ...
    public function showOffersMadeDetails($oid, $otitle) {
    	...
    	if (Session::has("traderToken")) {
	    	...
	    	return view('account_manager.my_offers.show_offer_made_details')->with($data);
    ...
    public function deleteOffersListedDetails($oid, $otitle) {
