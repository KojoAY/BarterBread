...
class ManageOffersMadeController extends Controller
{
    //
    public function showOffersMadeList($oid, $otitle){
    	...
    	if (Session::has("traderToken")) {
	        ...
	        $data = array(
                "pageTitle" => "Manage Offers Made - " . config('app.name', 'BarterBread'),
