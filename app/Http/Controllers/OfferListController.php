...
class OfferListController extends Controller
{
    ...
    public function index(){
        ...
        $data = array(
            "pageTitle" => "Offers | Swap Phones, Swap Laptops, Swap Cars and more - " . config('app.name', 'BarterBread'),
    ...
    public function showListByCategory($categ){
    	...
    	$data = array(
            "pageTitle" => $getMainCategById->category_name . " - " . config('app.name', 'BarterBread'),
    ...
    public function showOfferDetails($ref){
        ...
        */
    	...
    	$data = array(
            "pageTitle" => $getOfferDetails->title . " - " . config('app.name', 'BarterBread'),
