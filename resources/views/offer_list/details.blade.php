                                            ...
                                            <a id="trader-info">
                                                <article>
                                                    ...
                                                    $getTraderPersonalInfo = DB::table("bb_account")
                                                        ...
                                                        ->first();
                                                    ?>
                                                    <h4>{{ $getTraderPersonalInfo->fullname }}</h4>
                            ...
                            <article class="stats">
                                ...
                                <span id="share">
                                    ...
                                    <span>
                                        ...
                                        <!--a class="fa fa-whatsapp" href="whatsapp://send?text=https://www.barterbread.com/offers/details/{{ $shareRef }}" data-action="share/whatsapp/share"></a-->
